...
export default function AdminProductList() {
  ...
  useEffect(() => {
    fetch(`${API}/products`)
      ...
      .then((data) => {
        ...
        const currentProductOfTheDay = data.find(
          (product) => product.isProductOfTheDay
        );
      ...
      if (editingProduct.isProductOfTheDay) {
        ...
        setProducts(
          updatedProducts.map((p) => ({
            ...p,
            isProductOfTheDay:
              p.ID === editingProduct.ID || p._id === editingProduct._id,
          }))
        );
      } else if (
        productOfTheDay &&
        (productOfTheDay.ID === editingProduct.ID ||
          productOfTheDay._id === editingProduct._id)
      ) {
        setProductOfTheDay(null);
      }
    } catch (error) {
  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl dark:bg-gray-800 dark:text-gray-100">
      ...
      {productOfTheDay && <ProductOfDayBanner product={productOfTheDay} />}
