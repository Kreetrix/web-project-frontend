const PaymentMethod = ({ paymentMethod, setPaymentMethod }) => (
    <div className="bg-white dark:bg-gray-600 rounded-xl shadow-md p-6">
        <h3 className="text-xl font-bold mb-6 text-gray-800 dark:text-white">Maksutapa</h3>

        <div className="space-y-4">
            {/* Cash on delivery */}
            <div
                className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all ${paymentMethod === "cash" ? 'border-yellow-500 bg-yellow-50 dark:border-yellow-400 dark:bg-yellow-600' : 'border-gray-200 hover:border-gray-300 dark:border-gray-600 dark:hover:border-gray-500'}`}
            ...
            {/* Credit card */}
            <div
                className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all ${paymentMethod === "card" ? 'border-yellow-500 bg-yellow-50 dark:border-yellow-400 dark:bg-yellow-600' : 'border-gray-200 hover:border-gray-300 dark:border-gray-600 dark:hover:border-gray-500'}`}
            ...
            {/* MobilePay */}
            <div
                className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all ${paymentMethod === "mobilepay" ? 'border-yellow-500 bg-yellow-50 dark:border-yellow-400 dark:bg-yellow-600' : 'border-gray-200 hover:border-gray-300 dark:border-gray-600 dark:hover:border-gray-500'}`}
            ...
            {/* Bank transfer */}
            <div
                className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all ${paymentMethod === "bank" ? 'border-yellow-500 bg-yellow-50 dark:border-yellow-400 dark:bg-yellow-600' : 'border-gray-200 hover:border-gray-300 dark:border-gray-600 dark:hover:border-gray-500'}`}
        ...
        {paymentMethod === "card" && (
            <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <h4 className="text-sm font-medium mb-3 text-gray-700 dark:text-gray-200">Syötä korttitiedot</h4>
